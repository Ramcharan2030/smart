                    ...
                    >
                        ...
                        <AnimatePresence>
                            {showTooltip && (
                                ...
                                >
                                    <div className="bg-white text-[#0A0A1A] px-4 py-2.5 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.12)] border border-black/5 flex items-center gap-3">
                                        <div className="flex flex-col">
                                            <p className="text-[13px] font-bold leading-none">Need help?</p>
                                            <p className="text-[11px] text-[#4A4A5A] mt-1">Chat with us on WhatsApp</p>
                                        </div>
                                        <button 
                                            onClick={(e) => {
                                                e.preventDefault();
                                        ...
                                        <div className="absolute top-full right-5 w-3 h-3 bg-white border-r border-b border-black/5 rotate-45 -translate-y-1.5" />
                                    </div>
                                </motion.div>
                            )}
                        </AnimatePresence>
                        ...
                        >
                            ...
                            {/* Hover label */}
                            <span className="absolute right-full mr-4 px-3 py-1.5 rounded-lg bg-[#0A0A1A] text-white text-[12px] font-semibold opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all pointer-events-none whitespace-nowrap">
                                Chat with us
                            </span>
                        </a>
                    </motion.div>
